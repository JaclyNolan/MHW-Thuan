...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseAdmin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="admin/admin">List</a>
                <a class="collapse-item" href="admin/admin/create">Create</a>
                <a class="collapse-item" href="admin/admin">Edit</a>
                <a class="collapse-item" href="admin/admin">Delete</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSlide" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Action:</h6>
                <a class="collapse-item" href="admin/slide">List</a>
                <a class="collapse-item" href="admin/slide/create">Create</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <div id="collapseBanner" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Action:</h6>
                <a class="collapse-item" href="admin/banner">List</a>
                <a class="collapse-item" href="admin/banner/create">Create</a>
                <a class="collapse-item" href="admin/banner">Edit</a>
                <a class="collapse-item" href="admin/banner">Delete</a>
            </div>
        </div>
    </li>
